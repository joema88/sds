...
public class WatchList {
	...
	public static void main(String[] args) {
		...
		String query1 = "select SYMBOL,a.STOCKID,CLOSE, PERCENT, MARKCAP FROM BBROCK a, SYMBOLS b WHERE a.STOCKID = b.STOCKID and DATEID=8931 ORDER BY MARKCAP DESC limit 6300";
		...
		printUnprocessedStocksBasedOnFiles(520, query1);
	}
	...
	public static void printUnprocessedStocksBasedOnFiles(int num, String query1) {
		try {
			...
			System.out.println("Total selected stocks "+selectedStockCount);
