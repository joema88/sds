...
public class DB {
	...
	//3. CREATE TABLE BBROCK(STOCKID SMALLINT, DATEID SMALLINT, PERCENT FLOAT DEFAULT 0.0, CLOSE FLOAT DEFAULT 0.0,NETCHANGE FLOAT DEFAULT 0.0, ATR FLOAT DEFAULT 0.0, OPEN FLOAT DEFAULT 0.0,HIGH FLOAT DEFAULT 0.0, LOW FLOAT DEFAULT 0.0,LOW52 FLOAT DEFAULT 0.0,HIGH52 FLOAT DEFAULT 0.0, MARKCAP FLOAT DEFAULT 0.0,VOLUME INT DEFAULT 0, YELLOW TINYINT DEFAULT 0,TEAL TINYINT  DEFAULT 0, PINK TINYINT DEFAULT 0, SC5 SMALLINT DEFAULT 0,YP10 TINYINT DEFAULT 0, BT9 SMALLINT DEFAULT 0,TSC5 SMALLINT DEFAULT 0,DAYS SMALLINT DEFAULT 0, PTVAL FLOAT DEFAULT 0.0, PTCP FLOAT DEFAULT 0.0, PASS TINYINT DEFAULT 0,CX520 TINYINT DEFAULT 0, CCX SMALLINT DEFAULT 0 ,BDCX SMALLINT DEFAULT 0, BDW SMALLINT DEFAULT 0,PTCP2 FLOAT DEFAULT 0.0, DAY2 SMALLINT DEFAULT 0, ABT9 TINYINT DEFAULT 0, PRIMARY KEY (STOCKID, DATEID), FOREIGN KEY (STOCKID) REFERENCES SYMBOLS(STOCKID) ON DELETE CASCADE, FOREIGN KEY (DATEID) REFERENCES DATES(DATEID));
	//RECORDING THE CONTINUOUS VALUE OF CX520
	//ALTER TABLE BBROCK ADD COLUMN CCX SMALLINT DEFAULT 0 AFTER CX520;
	//RECORDING THE BOUNDARY AND 13 OF CCX COLUMN, UPDATE LOGIC OF CCX TO GET THIS UPDATED
	//ALTER TABLE BBROCK ADD COLUMN BDCX SMALLINT DEFAULT 0 AFTER CCX;
	//ALTER TABLE BBROCK ADD COLUMN BDW SMALLINT DEFAULT 0 AFTER BDCX;
	//ALTER TABLE BBROCK ADD COLUMN PTCP2 FLOAT DEFAULT 0.0 AFTER BDW;
	//ALTER TABLE BBROCK ADD COLUMN DAY2 SMALLINT DEFAULT 0 AFTER PTCP2;
